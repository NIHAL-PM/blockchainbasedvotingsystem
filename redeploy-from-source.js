...
// Simplified OnChainRegistry contract ABI and bytecode based on source
const contractABI = [
  {
    "inputs": [],
...
// Minimal bytecode for OnChainRegistry contract
...
async function redeployFromSource() {
    ...
    console.log("🔄 Redeploying OnChainRegistry from source...");
    ...
    try {
        ...
        // Authorize the deployer immediately
        ...
        console.log("\n💡 You can now refresh the dashboard at http://localhost:5173");
...
function updateConfigFiles(contractAddress) {
    try {
        ...
        console.log("✅ Updated blockchain.js with new contract");
